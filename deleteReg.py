...
def printResult(name, course):
    print(textwrap.dedent("""
        ...
        """.format(name, course, dba.delReg(name, course), time.ctime())))
...
def printForm():
    print(textwrap.dedent("""
        ...
        <div id="wrap">
        <div id="header">
        <h1><a href="#">Deroll a student from a course</a></h1>
        </div>
